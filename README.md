...
Frontend-разработчик, четвёртый год в вебе. Делаю интерфейсы на **React + TypeScript** и **Vue 3 / Nuxt 3** — от вёрстки и адаптива до архитектуры SPA и интеграции с API.

🎯 В фокусе: чистая модульная архитектура, аккуратный UI, работа с REST API, AI-assisted разработка.
💼 Открыт к предложениям (Frontend, удалёнка).

### 🛠 Стек

`React 19` · `TypeScript` · `Vue 3` · `Nuxt 3` · `MobX` · `Pinia` · `Vuex` · `Vite` · `React Router` · `REST API` · `SCSS / CSS`
